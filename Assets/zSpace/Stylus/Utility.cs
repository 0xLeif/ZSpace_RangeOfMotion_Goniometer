...
namespace zSpace.Common
{
	public static class Utility
	{
		...
		public static GameObject FindRigidBodyResolver (GameObject collidedObject)
		{
			...
			while (transform != null && transform.rigidbody == null && transform.parent != null)
			{
				transform = transform.parent;
			}
			GameObject result;
			if (transform != null && transform.rigidbody != null)
			{
		...
		{
			if (go.rigidbody != null || go.collider != null || go.renderer != null)
			{
